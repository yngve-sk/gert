...
def test_scan_and_start_experiment() -> None:
    ...
    scan_paths = [Path("examples/many_steps_many_iterations")]
    configs = _scan_for_configs(scan_paths)
    ...
    assert exp_id == "many_steps_many_iterations_many-steps-many-iterations"
    ...
    response = client.post(f"/experiments/{exp_id}/start")
